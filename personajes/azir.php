...
<br><br>
		<?php 
			foreach($pdo->query('SELECT * FROM campeones WHERE id ="10" ') as $row) {
		...
		<div class="col-sm-6">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="false">
				  ...
				  <div class="carousel-inner">
					...
					foreach($pdo->query('SELECT * FROM imagenes WHERE nombre_champ ="Azir" ') as $row) {
