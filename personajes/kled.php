...
<br><br>
		<?php 
			foreach($pdo->query('SELECT * FROM campeones WHERE id ="132" ') as $row) {
	...
	<br><br>
		...
		<?php 
			foreach($pdo->query('SELECT * FROM campeones WHERE id ="132" ') as $row) {
							    ...
							    echo "<li class='list-group-item' style='float:none;'>Posición: ".$row['posicion']." / ".$row['posicion2']."</li><br>";
		...
		<div class="col-sm-6">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="false">
				  ...
				  <div class="carousel-inner">
					...
					foreach($pdo->query('SELECT * FROM imagenes WHERE nombre_champ ="Kled" ') as $row) {
