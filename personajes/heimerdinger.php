...
<div class="row">
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">Heimerdinger</li>
		</ol>
	</div>
</div>
...
<br><br>
		<?php 
			foreach($pdo->query('SELECT * FROM campeones WHERE id ="37" ') as $row) {
		...
		<div class="col-sm-6">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="false">
				  ...
				  <div class="carousel-inner">
					...
					foreach($pdo->query('SELECT * FROM imagenes WHERE nombre_champ ="Heimerdinger" ') as $row) {
